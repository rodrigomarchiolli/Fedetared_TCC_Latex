...
\textbf{Typical metrics:} High accuracy (85-95\%), high precision and recall \cite{abdulrahman_alahmadi_32bc288c}.\\
...
\toprule
\textbf{Algorithm} & \textbf{Type} & \textbf{Accuracy} & \textbf{Noise Robustness} & \textbf{Computational Cost} & \textbf{Suitability for FL} & \textbf{Reference} \\ \midrule
ANN                & Non-linear    & High              & Medium                    & High                        & High                        & \cite{abdulrahman_alahmadi_32bc288c} \\ \midrule
Random Forest      & Non-linear    & High              & High                      & Medium-High                 & High                        & \cite{adam_sadilek_c59c73f4} \\ \midrule
SVM                & Linear/Non-linear & Medium-High   & Medium                    & Medium-High                 & Medium                      & \cite{hao_huang_8976046f} \\ \midrule
k-NN               & Non-linear    & Medium            & Low                       & Medium-Low                  & Medium                      & \cite{abdulrahman_alahmadi_32bc288c} \\ \midrule
Logistic Regression & Linear       & Medium            & Low-Medium                & Low                         & High                        & \cite{abdulrahman_alahmadi_32bc288c} \\ 
\bottomrule
\end{tabular}%
}
\end{table}
