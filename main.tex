...
\begin{itemize}
    ...
    \item \textbf{Code implementation:} AI-assisted code generation tools (GitHub Copilot) were employed to support the implementation of the ESP32 firmware, React Native mobile application, Python training scripts, and Flower federated learning integration. All generated code was reviewed and tested by the authors before integration.
