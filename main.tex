...
\begin{longtable}{p{3.2cm} p{3.8cm} p{2.5cm} p{3cm} p{1.8cm}}
\caption{Summary of articles included in the systematic review.}
...
\caption[]{Summary of articles included in the systematic review. (Continued)} \\
...
\begin{itemize}
    \item \textbf{Text writing and revision:} AI-based writing assistants were used for grammar checking, stylistic suggestions, and paragraph organization. No AI tool was used to generate the original research ideas, experimental results, or core scientific contributions.
    \item \textbf{Code implementation:} AI-assisted code generation tools were employed to support the implementation of the ESP32 firmware, React Native mobile application, Python training scripts, and Flower federated learning integration. All generated code was reviewed and tested by the authors before integration.
    \item \textbf{Figure and diagram generation:} The architecture diagram (Figure~\ref{fig:architecture}) was created using Whimsical, as indicated in the figure. The PRISMA flow diagram (Figure~\ref{fig:prisma}) was generated using the RAYYAN tool \cite{nastasha_johnson_93d644ed}. The experimental results charts were produced using matplotlib. The TabularMLP architecture diagram was produced using TikZ.
\end{itemize}
